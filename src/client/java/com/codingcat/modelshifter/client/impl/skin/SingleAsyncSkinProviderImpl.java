...
public class SingleAsyncSkinProviderImpl implements SingleAsyncSkinProvider {
    ...
    @Override
    public @NotNull Identifier getSkin() {
        Identifier cachedSkin = this.cachedSkin.get();
        return cachedSkin != null ? cachedSkin : this.getDefaultSkin(this.profile);
    }

    @Override
    public @NotNull Identifier getDefaultSkin(GameProfile profile) {
        //? >1.20.1 {
